...
class CaptureZodiacSignIntentHandler(AbstractRequestHandler):
    """Handler for Zodiac Sign Intent."""
    def can_handle(self, handler_input):
        # type: (HandlerInput) -> bool
    ...
    def handle(self, handler_input):
        ...
        month = slot["month"].value
        day = slot["day"].value
        
        
        #enter the sheet url
        url = "https://docs.google.com/spreadsheets/d/e/2PACX-1vRXBXH9aD48bq3Rq6-FhJ5qod_7bF9fI0c9zZYAPPohmYKpxwjvwYR8ivBNn2666G754m7KF-muhUgg/pub?gid=0&single=true&output=csv"
